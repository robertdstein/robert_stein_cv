...
& {\parbox{108mm}{\rule{0pt}{2pt}\normalsize{Graded ``\emph{Summa cum laude}'' (with distinction)}}}\\
& \begin{itemize}
...
\begin{longtable}{R{26mm}|p{110mm}}
	\textsc{26\textsuperscript{th} Mar 2021} & Winner of the \emph{IceCube Impact Award}, IceCube Spring 2021 Collaboration Meeting \\
	\multicolumn{2}{c}{} \\
...
\textsc{Aug. 2022 --}& {\parbox{108mm}{\rule{0pt}{2pt}Keck Observatory Program (PI)}}\\
...
\begin{longtable}{L{10mm} p{126mm}}
	...
	\bf 2022 & \textsc{R. Stein et al.},
	\emph{\href{https://arxiv.org/abs/2111.09390}{Neutrino Follow-Up with the Zwicky Transient Facility}},
	(submitted)\\
	&\emph{Lead author, data analysis, statistical analysis, led follow-up program}\\
	&\\	
	
	& \textsc{*J. Necker et al.},
